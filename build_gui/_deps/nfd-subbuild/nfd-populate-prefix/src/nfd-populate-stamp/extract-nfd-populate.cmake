...
#
get_filename_component(filename "D:/MDL/build_gui/_deps/nfd-subbuild/nfd-populate-prefix/src/86f742bab39f1b253ad111e8ce776b46dd1ccdbe.zip" ABSOLUTE)
get_filename_component(directory "D:/MDL/build_gui/_deps/nfd-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-nfd-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-nfd-populate${i}")
